...
theme_nyloncalc <- function(base_size = 12,base_family="") {
  theme(
        ...
        axis.title.x =          element_text(size=12,colour="#535353",face="bold",family="Gulim",vjust=0),
        axis.title.y =          element_text(size=12,colour="#535353",face="bold",family="Gulim",angle=90,vjust=1),
